  ...
  const fetchResources = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log("Dataaaaa videoooosss:", data);
      ...
      <Tab.Container className="list-patient-dashboard" id="list-group-tabs">
        ...
        <Tab.Content className="tab-content-wrapper">
          <div className="patient-activities-page-header">
            ...
            <h1 className="patient-activities-page-therapist-title">Reading</h1>
          </div>
...
export default ReadingPatientPage;
