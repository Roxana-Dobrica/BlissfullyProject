      ...
      <Tab.Container className="list-patient-dashboard" id="list-group-tabs">
        ...
        <Tab.Content className="tab-content-wrapper">
          <div className="patient-activities-page-header">
            ...
            <h1 className="patient-activities-page-therapist-title">Videos</h1>
          </div>
          ...
          <div className="cards-section-patient">
            {filteredResources &&
              ...
              filteredResources
                ...
                .map((resource, index) => (
                  <div
                    className="card card-resources card-resources-patient-page"
                    key={resource.materialId}
                  >
                    <img
                      src={`/images/Resources/resource${((index + 5) % 16) +
                        1}.jpg`}
...
export default VideosPatientPage;
